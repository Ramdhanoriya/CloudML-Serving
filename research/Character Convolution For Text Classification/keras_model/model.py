...
class CNNModel(object):
    ...
    def build_model(self, optimizer='adam', loss='binary_crossentropy'):
        ...
        x = Conv1D(filters=self.filters[0], kernel_size=self.kernels[0])(input_)
    ...
    def train(self, inputs, labels, epochs=20, batch_size=50, validation_split=0.3):
        ...
        self.model.fit(x=inputs, y=labels, epochs=epochs, batch_size=batch_size, validation_split=validation_split)
