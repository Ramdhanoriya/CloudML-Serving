...
def model_fn(features, labels, mode, params):
    ...
    f1 = tf.keras.layers.Embedding(params.N_WORDS, 30, input_length=commons.MAX_DOCUMENT_LENGTH)(word_id_vector)
    ...
    f1 = tf.keras.layers.Dense(256)(f1)
    f1 = tf.keras.layers.Dropout(0.2)(f1)
    f1 = tf.keras.layers.Activation('relu')(f1)
    logits = tf.keras.layers.Dense(2)(f1)
